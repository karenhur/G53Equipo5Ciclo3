...
<body>
	...
	<div class="input-group mb-3">
		...
		<div class="col-xxl-1">
			<input type="text" class="form-control"
				...
				disabled="disabled" placeholder="0.0">
		</div>
	...
	<div class="opciones1">
		<button type="button" class="btn btn-success"
			onclick="confirmarventa() confirmardetalle()">
	...
	<script>
		...
		function sumartotal() {
			var valor_total1 = parseFloat(document
					.getElementById("valor_total1").value);
			var valor_total2 = parseFloat(document
					.getElementById("valor_total2").value);
			var valor_total3 = parseFloat(document
					.getElementById("valor_total3").value);
			valorglobal = valor_total1 + valor_total2 + valor_total3;
